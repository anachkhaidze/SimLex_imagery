  ...
  axios.post(url, data, {headers: headers})
    .then(response => {
      ...
      if (response.data.score > 0.2) {
        ...
        window.location.href = "/irq/error";
      }
    });
}
...
var consent = {
  ...
  html: `
             <div>
              ...
              <a target="_blank" href="/static/irq/consent.pdf">Open in a new tab</a>
              
              <div id='consent-container'>
                <iframe src="/static/irq/consent.pdf#view=FitH&zoom=FitH"
...
var timeline = [welcome, start_fullscreen, subjectCode];
trialCount += 1;
